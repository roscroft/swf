import re
# Cleaning input file:
# Replace Alt-010 (line break) with space
# Remove all commas
...
with open ("./nicknames.txt", "r+") as nickname_file:
    nicknames = "|".join([line.rstrip() for line in nickname_file])
    sub_dict["nicknames"] = nicknames
